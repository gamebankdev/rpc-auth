/**
 * @file JSONRPC 2.0 request authentication with gamebank authorities.
 */

import {hexify, PrivateKey} from 'gamebank_libcrypto'
import {createHash, randomBytes} from 'crypto'

/**
 * Signing constant used to reserve opcode space and prevent cross-protocol attacks.
 * Output of `sha256('gamebank_jsonrpc_auth')`.
 */
...
export interface SignedJsonRpcRequest extends JsonRpcRequest {
    params: {
        __signed: {
            ...
            timestamp: string
            /** Signers gamebankit account name */
            account: string
 ...
 * @param account    gamebank account name that is the signer.
 ...
 *
 * Responsible for:
 *   1. Account must be a valid gamebank blockchain account
